...
import useDidMountEffect from '@sendbird/uikit-react/Channel';
import SuggestedMentionList from '@sendbird/uikit-react/Channel';
import useSendbirdStateContext from '@sendbird/uikit-react/useSendbirdStateContext';
import { useChannelContext } from '@sendbird/uikit-react/Channel/context';
import { j as getClassName } from '@sendbird/uikit-react/index-43834bc0.js';
import {
  a as isDisabledBecauseFrozen,
  b as isDisabledBecauseMuted,
} from '@sendbird/uikit-react/ChannelProvider-c1c00018.js';
...
import { M as MessageInputKeys } from '@sendbird/uikit-react/const-0f759572';
import { u as useLocalization } from '@sendbird/uikit-react/LocalizationContext-8725e9b2';
...
const Message = ({
  ...
  const { userId, isOnline, isMentionEnabled, userMention } = globalStore?.config;
  ...
  return (
    ...
    >
      ...
      {showFileViewer && <FileViewer message={message} onCancel={() => setShowFileViewer(false)} />}
    </div>
  );
};
