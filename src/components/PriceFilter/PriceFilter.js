...
const getPriceQueryParam = queryParamNames => {
...
class PriceFilter extends Component {
  ...
  render() {
    ...
    const urlParam = getPriceQueryParam(queryParamNames);
    ...
    return showAsPopup ? (
      ...
      >
        ...
        <div>
          <label className={css.currencySymbolLabel}>
            {intl.formatMessage({ id: 'PriceFilter.currencySymbol' })}
          </label>
          <FieldTextInput
            className={css.field}
            ...
            autoComplete="off"
          />
          <label className={css.unitLabel}>{intl.formatMessage({ id: 'PriceFilter.unit' })}</label>
        </div>
      </FilterPopup>
    ) : (
      <FilterPlain
