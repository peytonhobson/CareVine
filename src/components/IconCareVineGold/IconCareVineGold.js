    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset=".06" stop-color="#d3a63d" />
          <stop offset=".16" stop-color="#e6cb5a" />
          <stop offset=".27" stop-color="#fcf67c" />
          <stop offset=".32" stop-color="#f2e871" />
          <stop offset=".43" stop-color="#dbc456" />
          <stop offset=".57" stop-color="#b58a2a" />
          <stop offset=".57" stop-color="#b38728" />
          <stop offset=".81" stop-color="#fcf67c" />
          <stop offset=".85" stop-color="#f9f178" />
          <stop offset=".89" stop-color="#f2e36d" />
          <stop offset=".93" stop-color="#e6cc5b" />
          <stop offset=".98" stop-color="#d6ad43" />
